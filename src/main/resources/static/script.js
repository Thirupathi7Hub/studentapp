...
function showSection(name) {
  ...
  // Hide search bar on Add Student, show on All Students
  const searchBox = document.querySelector('.search-box');
  if (searchBox) {
    searchBox.style.display = name === 'list' ? 'block' : 'none';
  }
  ...
  // Clear form when switching to add
  if (name === 'add') {
...
function saveStudent() {
  ...
  .then(() => {
    ...
    // Clear form fields
    ['edit-id','f-name','f-email','f-phone',
     'f-age','f-dept','f-year','f-gender'].forEach(id => {
